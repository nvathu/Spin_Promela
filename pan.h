...
#define PanSource	"voss24_project1_format.pml"
...
#define _nstates2	14	/* :init: */
#define minseq2	101
#define maxseq2	113
#define _endstate2	13

#define _nstates1	38	/* Airplane */
#define minseq1	64
#define maxseq1	100
#define _endstate1	37

#define _nstates0	65	/* Tower */
#define minseq0	0
#define maxseq0	63
...
#define PAirplane	((P1 *)_this)
typedef struct P1 { /* Airplane */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define PTower	((P0 *)_this)
typedef struct P0 { /* Tower */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
